...
export default defineConfig({
  testDir: './tests',
  testMatch: ['mobile-webkit.spec.js', 'mobile-layout.spec.js', 'mobile-input.spec.js', 'mobile-performance.spec.js', 'pack-visuals.spec.js', 'lobby.spec.js', 'audio.spec.js', 'ping.spec.js', 'combat-polish.spec.js', 'duel.spec.js', 'new-realm.spec.js', 'moba-controls.spec.js', 'mobile-rendering.spec.js', 'responsive-controls.spec.js', 'motion-regression.spec.js', 'gameplay-ux.spec.js', 'startup-loading.spec.js'],
  timeout: 60000,
